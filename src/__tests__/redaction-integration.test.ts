/**
 * Integration tests for LogEngine with data redaction
 * Tests the complete flow from LogEngine API to redacted output
 */
...
describe('LogEngine with Data Redaction', () => {
    ...
    describe('Environment-based redaction control', () => {
